    ...
    <section ref={ref} className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="container-custom section-padding relative z-10">
        <div className={`text-center max-w-4xl mx-auto transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          ...
          {/* Main heading */}
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-fredoka text-white mb-6 leading-tight animate-fade-in-up drop-shadow-lg" style={{animationDelay: '0.2s'}}>
            Libérez le <span className="text-secondary">potentiel</span> de votre enfant pour qu'il puisse 
            <span className="text-secondary"> briller</span>
          </h1>
          ...
          <p className="text-base sm:text-lg md:text-xl text-white/90 mb-8 sm:mb-12 max-w-2xl mx-auto leading-relaxed animate-fade-in-up drop-shadow-md px-4" style={{animationDelay: '0.4s'}}>
            Chez les Petits Rayons de Soleil, nous accompagnons vos enfants dans un environnement bienveillant et sécurisé où ils s'épanouissent, apprennent et grandissent avec joie. 
          </p>
