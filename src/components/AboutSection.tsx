              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-1 gap-4">
                <div className="bg-secondary rounded-2xl p-4 sm:p-6">
                  <div className="flex items-center space-x-3 sm:space-x-4">
                    <div className="text-3xl sm:text-4xl font-fredoka text-primary-foreground">+80</div>
                    <div className="text-xs sm:text-sm text-primary-foreground">
                      Enfants confiés par <br /> leurs parents
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-accent rounded-2xl p-4 sm:p-6">
                  <div className="flex items-center space-x-3 sm:space-x-4">
                    <div className="text-3xl sm:text-4xl font-fredoka text-primary-foreground">+10</div>
                    <div className="text-xs sm:text-sm text-primary-foreground">
                    Professionnels <br />passionnés et formés 
                    </div>
                  </div>
                </div>

                <div className="rounded-2xl p-4 sm:p-6" style={{ backgroundColor: 'red' }}>
                  <div className="flex items-center space-x-3 sm:space-x-4">
                    <div className="text-3xl sm:text-4xl font-fredoka text-primary-foreground"></div>
                    <div className="text-xs sm:text-sm text-primary-foreground">
                      Espace de jeux spacieux et équipé 
                    </div>
                  </div>
                </div>
